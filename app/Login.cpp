...
extern "C"{
    JNIEXPORT jboolean JNICALL Java_com_example_ace_obo_OBOJni_Login(JNIEnv *env, jobject obj, jstring jusername, jstring jpasswd, jboolean jisDriver){
        const char* username = env->GetStringUTFChars(jusername, NULL);
        const char* password = env->GetStringUTFChars(jpasswd, NULL);
        const char* isDriver = (jisDriver==JNI_TRUE)?"true":"no";
        ...
        /**
         * 给服务器段的协议 https://ip:port/login [json_data]
         * {
         *      username: "aaa",
         *      passwd: "bbb",
         *      driver: "yes"
        ...
        const char *uri = "https://ip:port/login";
